...
3. **Review Task**: Run the review task using `deep-cot-subagent` per `docs/workflows/tasks/review-task.md`.
...
5. **Functional Testing Task**: Run the functional testing task using `fast-subagent` per `docs/workflows/tasks/func-testing-task.md` and ensure all functional and E2E tests pass.